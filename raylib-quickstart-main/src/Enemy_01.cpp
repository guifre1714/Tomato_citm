...
void EN01::Dead() {//Function that immobilizes the enemy and loads the death animation.
    move = false;
    EN_col = { 0, 0, 0, 0 };
    UnloadTexture(EN_texture);
...
void EN01::Direction() {//Function that changes the direction of movement depending on parameters others than the timer.
    colUp = false;
    colDown = false;
    colLeft = false;
    colRight = false;
